...
#include "../inst/include/RcppTestArea.h"
#include <RcppEigen.h>
#include <Rcpp.h>
#include <string>
#include <set>
...
// StatTest
std::vector<double> StatTest(Eigen::MappedSparseMatrix<double> X, std::vector<int> interest, std::vector<int> backgound, double logFCcut, bool display_progress);
RcppExport SEXP _RcppTestArea_StatTest(SEXP XSEXP, SEXP interestSEXP, SEXP backgoundSEXP, SEXP logFCcutSEXP, SEXP display_progressSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static int _RcppTestArea_RcppExport_validate(const char* sig) { 
...
RcppExport SEXP _RcppTestArea_RcppExport_registerCCallable() { 
    R_RegisterCCallable("RcppTestArea", "_RcppTestArea_RcppExport_validate", (DL_FUNC)_RcppTestArea_RcppExport_validate);
    return R_NilValue;
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_RcppTestArea_RcppExport_registerCCallable", (DL_FUNC) &_RcppTestArea_RcppExport_registerCCallable, 0},
    {NULL, NULL, 0}
};
