...
// StatTest
extern SEXP StatTest(Eigen::MappedSparseMatrix<double> X, std::vector<int> interest, std::vector<int> backgound, double logFCcut, double minPct);
RcppExport SEXP _FastWilcoxTest_StatTest(SEXP XSEXP, SEXP interestSEXP, SEXP backgoundSEXP, SEXP logFCcutSEXP, SEXP minPctSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(StatTest(X, interest, backgound, logFCcut, minPct));
    return rcpp_result_gen;
END_RCPP
}
// ZScore
